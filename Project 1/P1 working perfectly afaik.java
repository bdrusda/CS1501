    ...
    public static void main(String[] args)
    {
        ...
        while(true)
        {
            ...
            while(true)
            {
                ...
                {
                    System.out.println("WORD COMPLETED:\t"+suggestions[userIn-49]);
                ...
                else if(userIn == 33)                       /*If it's !, terminate the program*/
                {
                    ...
                    System.out.println("Average time: "+(BigDecimal.valueOf(total_prediction_time/num_predictions).toPlainString()));
                ...
                else                                        /*If it's anything else, that's a character that we want to add to the existing search*/
                {
                    ...
                    System.out.println("("+BigDecimal.valueOf(result_seconds).toPlainString()+" s)");
                    ...
                    else    //if there are no suggestions, notify the userIn
                    {
                        ...
                        user.add_word(partial.toString());                 /*Add user's word to the current trie*/
    //Do all of the jazz that should happen when userIn == 36
                        try
                        {
                            BufferedWriter append_user = new BufferedWriter(new FileWriter("user_history.txt", true));  /*Save the user's word in a text file*/
                            append_user.write(partial.toString());
